...
enum AppleRemindersError: Error, CustomStringConvertible {
    ...
    var description: String {
        switch self {
        case .accessDenied:
            return "JingleRemindersAccessDenied"
        case .invalidRequest(let message):
            return "JingleInvalidRemindersRequest: \(message)"
        case .listNotFound:
            return "JingleReminderListNotFound"
        case .reminderNotFound:
            return "JingleReminderNotFound"
        case .saveFailed:
            return "JingleReminderSaveFailed"
        case .unsupportedMethod(let method):
            return "JingleUnsupportedMethod: \(method)"
        }
    }
}
...
@main
struct JingleAppleRemindersMain {
