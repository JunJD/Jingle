...
import { getJingleHomeDir, hasExplicitJingleStorageHome } from "../storage"
...
function resolveConfigDir(): string {
  ...
  if (hasExplicitJingleStorageHome()) {
    return join(getJingleHomeDir(), "jingle-config")
  }
...
function resolveDataDir(): string {
  ...
  if (hasExplicitJingleStorageHome()) {
    return join(getJingleHomeDir(), "jingle-data")
  }
