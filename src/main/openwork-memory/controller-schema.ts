import {
  ...
  OPENWORK_MEMORY_STATUSES,
  OPENWORK_MEMORY_SUGGESTION_STATUSES,
...
const memoryTypeSchema = z.enum(OPENWORK_MEMORY_TYPES)
const memoryScopeSchema = z.enum(OPENWORK_MEMORY_SCOPES)
const memoryStatusSchema = z.enum(OPENWORK_MEMORY_STATUSES)
const suggestionStatusSchema = z.enum(OPENWORK_MEMORY_SUGGESTION_STATUSES)
