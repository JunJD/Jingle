...
export const JINGLE_TODO_TOOL_DESCRIPTION = `Create and maintain jingle's structured task list for the current work session. Use it as an attention anchor for complex, multi-step work: track the active step, remaining work, blockers, and verification so the task does not drift in long tool loops.
...
export function createJingleTodoMiddleware() {
