...
export function formatFileMutationLineStatsValue(stats: FileMutationLineStats): string | null {
  const parts = [
...
export function formatFileMutationLineStats(file: FileMutationFileViewModel): string | null {
  return formatFileMutationLineStatsValue(getFileMutationLineStats(file))
}
