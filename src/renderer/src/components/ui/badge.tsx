...
const badgeVariants = cva(
  "inline-flex items-center rounded-sm border px-[var(--ow-space-2)] py-[var(--ow-space-0-5)] [font-size:var(--ow-font-caption)] font-semibold uppercase tracking-wider transition-colors",
  {
    variants: {
      variant: {
