...
function DialogTitle({ className, ...props }: DialogTitleProps): React.JSX.Element {
  return (
    <DialogPrimitive.Title
      className={cn(
        "[font-size:var(--ow-font-title)] font-semibold leading-none tracking-tight",
        className
      )}
      {...props}
    />
