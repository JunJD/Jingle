...
function AnthropicLogo(props: ProviderLogoProps): React.JSX.Element {
...
function OpenAILogo(props: ProviderLogoProps): React.JSX.Element {
  const { className } = props
...
function GoogleLogo(props: ProviderLogoProps): React.JSX.Element {
  const { className } = props
...
function DeepSeekLogo(props: ProviderLogoProps): React.JSX.Element {
  const { className } = props
...
function DashScopeLogo(props: ProviderLogoProps): React.JSX.Element {
  const { className } = props
