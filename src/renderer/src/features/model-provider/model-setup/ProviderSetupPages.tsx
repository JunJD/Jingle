      ...
      <div className="flex min-w-0 items-center gap-[var(--ow-space-2)]">
        {props.onBack ? (
          <button
            type="button"
            aria-label="返回"
            className="inline-flex h-8 w-8 items-center justify-center rounded-[var(--ow-radius-md)] text-muted-foreground transition hover:bg-background-secondary hover:text-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:cursor-default disabled:opacity-50"
