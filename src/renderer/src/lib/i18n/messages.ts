...
export const appCopy: Record<AppLocale, AppCopy> = {
  "zh-CN": {
    ...
    toolCall: {
      ...
      labels: {
        computer_use_action: "操作应用",
        computer_use_expand: "展开应用状态",
        computer_use_inspect: "检查应用元素",
        computer_use_observe: "观察应用",
        computer_use_search: "搜索应用状态",
        edit_file: "编辑文件",
        execute: "执行命令",
  ...
  "en-US": {
    ...
    toolCall: {
      ...
      labels: {
        computer_use_action: "Use Application",
        computer_use_expand: "Expand Application State",
        computer_use_inspect: "Inspect Application Element",
        computer_use_observe: "Observe Application",
        computer_use_search: "Search Application State",
        edit_file: "Edit File",
