...
export interface RuntimeRunBotAgentActionProps {
  disabled?: boolean
  icon?: IconLike
...
type RuntimeActionComponent = ((props: RuntimeActionProps) => ReactElement) & {
  ...
  RunBotAgent: (props: RuntimeRunBotAgentActionProps) => ReactElement
...
function RunBotAgentAction(props: RuntimeRunBotAgentActionProps): ReactElement {
  const { icon, input, title = "Run with Agent", ...hostProps } = props
  return createElement(
    ExtensionHostElement.Action,
    {
      actionKind: ExtensionHostActionKind.RunBotAgent,
      input,
      ...hostProps,
      title
    },
...
export namespace Action {
  ...
  export type RunBotAgent = RuntimeRunBotAgentActionProps
