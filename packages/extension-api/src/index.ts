...
export const openCommandPreferences = extensionRuntimeSdk.openCommandPreferences
export const openExtensionPreferences = extensionRuntimeSdk.openExtensionPreferences
