export const knownNotionTransform = {
  ...
  run(context) {
    const sourceText = rewriteKnownNotionSourceForOpenwork(context.sourceText, context.filePath)
    return {
      diagnostics:
...
function rewriteKnownNotionSourceForOpenwork(sourceText, filePath) {
  const rewrittenSource = rewriteKnownNotionOauthSourceForOpenwork(
