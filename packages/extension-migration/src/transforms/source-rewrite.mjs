...
export function rewriteSourceForOpenwork(sourceText, filePath, target, options = {}) {
  const rewrittenSource = rewriteGenericSourceForOpenwork(sourceText, filePath, target)
...
export function rewriteGenericSourceForOpenwork(sourceText, filePath, target) {
