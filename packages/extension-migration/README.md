# @jingle/extension-migration

Migration tooling for turning external extension source packages into Jingle extension packages.

The first tool in this package analyzes a Raycast extension and emits a structured Jingle migration preview:
...
The package is intentionally a migration-time tool. Generated Jingle packages should depend on `@jingle/extension-api` and `@jingle/extension-utils`, not on source runtime packages.
