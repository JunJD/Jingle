...
export function PageListItem({
  ...
  const quickEditProperties = databaseProperties?.filter((property) =>
    ["checkbox", "date", "status", "select", "multi_select", "people"].includes(property.type)
  )
  ...
  const OpenPageActions = isNotionApp(open_in) // Default app is Notion
    ? primaryAction == "notion"
      ? [OpenInAppAction, OpenInOpenworkAction, OpenInBrowserAction]
      : [OpenInOpenworkAction, OpenInAppAction, OpenInBrowserAction]
    : primaryAction == "notion"
      ? [OpenInBrowserAction, OpenInOpenworkAction]
      : [OpenInOpenworkAction, OpenInBrowserAction]
