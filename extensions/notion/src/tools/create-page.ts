...
import { createDatabasePage } from "../../domain";
import { getNotionClient, notionConnection } from "../../domain/client";
...
export default withAccessToken(notionConnection)(async ({ databaseId, title, content }: Input) => {
...
export const confirmation = withAccessToken(notionConnection)(async (params: Input) => {
