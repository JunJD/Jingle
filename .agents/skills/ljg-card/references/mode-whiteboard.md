...
Read `.agents/skills/ljg-card/assets/whiteboard_template.html`
...
```bash
node .agents/skills/ljg-card/assets/capture.js /tmp/ljg_cast_whiteboard_{name}.html ~/Downloads/{name}.png 1080 800 fullpage
```
