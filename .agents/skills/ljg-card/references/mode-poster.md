...
Read `.agents/skills/ljg-card/assets/poster_template.html`
...
```bash
node .agents/skills/ljg-card/assets/capture.js /tmp/ljg_cast_poster_{name}_{N}.html ~/Downloads/{name}_{N}.png 1080 1440
```
