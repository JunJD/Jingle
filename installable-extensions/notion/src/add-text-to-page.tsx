...
import { Action, ActionPanel, Form, Icon, LaunchProps, Toast, showToast } from "@jingle/extension-api";
import { FormValidation, useForm, withAccessToken } from "@jingle/extension-utils";
import { markdownToBlocks } from "@tryfabric/martian";
import { useState } from "react";

import { useSearchPages } from "./hooks";
import { appendBlockToPage, getPageIcon } from "../domain";
...
export function AddTextToPage(props: LaunchProps<{ arguments: Arguments.AddTextToPage }>) {
...
const AddTextToPageCommand = withAccessToken(notionConnection)(AddTextToPage);

export default AddTextToPageCommand;
