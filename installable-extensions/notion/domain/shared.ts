...
import { Color, Icon } from "@jingle/extension-api"
...
export function isType<P extends { type: string }, T extends P["type"]>(
  property: P,
  ...types: T[]
...
export function getPropertyIcon(property: { type: string }) {
