...
4. 运行单个目标 BDD。
5. 通过后才进入下一个 pause。
6. 如果遇到“当前不会、但这次推进必须理解”的知识点，同步登记到 [learn.md](/Users/junjieding/dingjunjie_dev/2026_03/openwork/learn.md)。
7. 如果引入兼容层、双写、过渡 shim，同步登记到 [cleanups.md](/Users/junjieding/dingjunjie_dev/2026_03/openwork/cleanups.md)。
...
- 删除兼容注册方式
- 删除双写和过渡 shim
- 清空 [cleanups.md](/Users/junjieding/dingjunjie_dev/2026_03/openwork/cleanups.md) active list
