...
When("我读取 native extensions 设置 schema", async function (this: JingleWorld) {
...
When(
  ...
  async function (this: JingleWorld, extensionName: string, table: DataTable) {
...
When(
  ...
  async function (this: JingleWorld, extensionName: string, commandName: string) {
...
When(
  ...
  async function (this: JingleWorld, extensionName: string, method: string) {
...
Then(
  ...
  function (this: JingleWorld, extensionName: string, title: string) {
...
Then(
  ...
  function (this: JingleWorld, extensionName: string) {
    const schemas = JSON.parse(
      this.getScenarioValue("nativeExtensions.schemas")
    ) as InstalledNativeExtensionSettingsSchema[]
...
Then(
  ...
  function (this: JingleWorld, extensionName: string, commandName: string, title: string) {
    const schemas = JSON.parse(
      this.getScenarioValue("nativeExtensions.schemas")
    ) as InstalledNativeExtensionSettingsSchema[]
    const schema = findSchema(schemas, extensionName)
...
Then(
  ...
  function (this: JingleWorld, extensionName: string, preferenceName: string) {
    const schemas = JSON.parse(
      this.getScenarioValue("nativeExtensions.schemas")
    ) as InstalledNativeExtensionSettingsSchema[]
    const schema = findSchema(schemas, extensionName)
...
Then(
  ...
  function (this: JingleWorld, commandId: string, preferenceName: string) {
...
Then(
  ...
  function (this: JingleWorld, key: string, value: string) {
...
Then(
  ...
  function (this: JingleWorld, key: string) {
    const record = JSON.parse(
      this.getScenarioValue("nativeExtensions.commandPreferences")
    ) as Record<string, unknown>
...
Then(
  ...
  async function (this: JingleWorld, windowLabel: string, commandId: string) {
...
Then(
  ...
  function (this: JingleWorld, expectedMessage: string) {
