...
import { resolveFileMutationChangeType } from "../../../src/main/agent/tool-approval-middleware"
import { extractHitlRequestFromValuesState } from "../../../src/main/agent/runtime-state"
...
interface ToolApprovalWorld extends OpenworkWorld {
...
function createWorkspace(world: ToolApprovalWorld): string {
  ...
  const workspaceDir = mkdtempSync(join(tmpdir(), "openwork-bdd-tool-approval-"))
