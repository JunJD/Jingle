...
async function getAgentLocale(world: JingleWorld): Promise<AppLocale> {
  const page = await world.getPageByKind("launcher")
...
async function getLauncherWindowMode(world: JingleWorld): Promise<LauncherWindowMode> {
  const page = await world.getPageByKind("launcher")
...
When(
  ...
  async function (this: JingleWorld, windowMode: LauncherWindowMode) {
...
Then(
  ...
  async function (this: JingleWorld, expectedLocale: AppLocale) {
...
Then(
  ...
  async function (this: JingleWorld, expectedWindowMode: LauncherWindowMode) {
