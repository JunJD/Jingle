...
import type { ExecuteCommandGuardrailMetadata } from "../../../src/main/agent/execute-command-guardrail-provider"
import type { GuardrailDecision } from "@jingle/langchain-agent-harness/transitional"
import type {
  MutationPrediction,
...
interface ExecuteCommandGuardrailScenarioState {
  decision: GuardrailDecision<ExecuteCommandGuardrailMetadata> | null
  predictorCalls: number
  prediction: MutationPrediction
}

interface ExecuteCommandGuardrailWorld extends JingleWorld {
...
function getDecision(
  world: ExecuteCommandGuardrailWorld
): GuardrailDecision<ExecuteCommandGuardrailMetadata> {
