...
function printUsage() {
  console.log(`Usage: npm run ui-audit:launcher -- [--cdp-port 9333] [--out test-results/ui-audit]

Connects to a running Openwork Electron renderer over CDP and captures runtime
style evidence for launcher UI work. Start Openwork with:
